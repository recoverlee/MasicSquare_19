...
**동기 본:** `docs/PRD.md` (내용은 동일하다. 갱신 시 둘 중 한 곳을 기준으로 맞춘 뒤 동기화하는 것을 권장한다.)  
...
| **프롬프트/보고** | `Prompting/`는 작성 가이드이고, **요구의 최종 권한은** PRD + `Report/` + `.cursorrules`에 맞출 것 |
...
| 날짜 | 변경 |
|------|------|
| 2026-04-28 | `docs/PRD.md`·`Report/`·`Prompting/`·`.cursorrules` 기준 PRD 보고서로 내보내기 |

---

*요구 정정은 Invariant/계약 변경에 반영한 뒤, `docs/PRD.md`와 본 보고서를 동기화한다.*
